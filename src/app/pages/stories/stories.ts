...
export class Stories {
  ...
  readonly characters = [
    ...
    },
    {
      archive: '06',
      name: 'Jey',
      tagline: 'La voz que lo devuelve a la Tierra',
      image: '/images/voyager/characters/jey.webp',
      badge: 'Fuera de la academia',
      age: '16–17 años',
      origin: 'Costa Rica, Tierra',
      academy: 'No pertenece a Horizon Academy',
      specialty: 'Intuición, empatía y conexión humana',
      personality: 'Espontánea, divertida, cercana, curiosa y valiente.',
      contribution: 'Mantiene a Andrew conectado con la realidad y le recuerda por quién vale la pena construir el futuro.',
    },
  ];
  selectedChapter = 1;
